...
print('  <form action="register_product.cgi" method="post">')
...
print('  </form>')
print('')
print('  <form action="/remove_product" method="post">')
...
print('  <form action="/modify_product_price" method="post">')
...
print('  </form>')
print('')
print('  <form action="/modify_product_description" method="post">')
...
print('  <form action="/register_customer" method="post">')
...
print('    <label for="client_register_name">Customer Name</label>')
print('    <input type="text" id="client_register_name" name="client_register_name" required>')
print('    <label for="client_register_email">Customer Email</label>')
print('    <input type="email" id="client_register_email" name="client_register_email" required>')
print('    <label for="client_register_phone">Customer Phone</label>')
print('    <input type="tel" id="client_register_phone" name="client_register_phone" pattern="[0-9]{9}" required>')
print('    <label for="client_register_address">Customer Address</label>')
print('    <input type="text" id="client_register_address" name="client_register_address" required>')
print('    <input type="submit" value="Register Customer">')
print('  </form>')
print('')
print('  <form action="/remove_client" method="post">')
...
print('  <form action="/make_order" method="post">')
print('    <label for="product_id_order">Product ID:</label>')
print('    <input type="text" id="product_id_order" name="product_id_order" required>')
print('    <label for="client_id_order">Client ID:</label>')
